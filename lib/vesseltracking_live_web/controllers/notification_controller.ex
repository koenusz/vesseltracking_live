defmodule VesseltrackingLiveWeb.NotificationController do
  ...
  def find_by_user_id(conn, _params) do
    notifications = Notifications.list_notifications_by_user(conn.assigns[:user_id])
    render(conn, "index.json", notifications: notifications)
  end
